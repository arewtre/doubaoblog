...
class IndexController extends CommonController
{
    public function index(Request $request)
    {
        ...
        $data = News::select('news.update_editor','news.art_description','news.art_id','news.type','news.updated_at','news.cate_id','news.art_thumb','news.art_title','news.art_rep','news.art_view','news_category.defectsname','news.created_at')
        ...
        return view('home.index',compact('adv','article','data','hot','advtop',"link",'tags','count','forum','member','gonggao','fmod'));
    }
