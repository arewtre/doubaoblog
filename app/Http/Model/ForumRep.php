...
class ForumRep extends Model{
    protected $table = 'forum_rep';
     ...
     * @return array
     */
    static public function listToTree($list, $pk='repid', $pid = 'rep_id', $child = '_child', $root = '0') {
        $tree = array();
        if(is_array($list)) {
            $refer = array();
    ...
    static public function formatTree($list, $lv = 0, $title = 'content'){
        $formatTree = array();
