...
private static $data;
//APP ID
private $app_id="101417835";
//APP KEY
private $app_key="d26f0f478c0c4ac44dc95ce05dfed35e";
//回调地址
private $callBackUrl="http://linxinran.cn/qq_login_callback";
//Authorization Code
private $code="";
//access Token
private $accessToken="";
private $openid="";
    ...
    public function __construct(){
        $this->app_id="101417835";
        $this->app_key="d26f0f478c0c4ac44dc95ce05dfed35e";
        if(isMobile()){
            $this->callBackUrl="http://linxinran.cn/wap/qq_login_callback"; //你的回调地址
        }else{
            $this->callBackUrl="http://linxinran.cn/qq_login_callback"; //你的回调地址
        }
        //检查用户数据
...
public function getInfo($openid='',$accessToken=''){
    ...
    $url=$url."?".$param;
    $rzt=$this->getUrl($url);
    $info = json_decode($rzt,JSON_UNESCAPED_UNICODE);
    //pre($info);
    return $info;
}
