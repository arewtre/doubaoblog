            ...
            <form class="layui-form layui-form-pane" id="formid" action="">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="art_title" required value="" lay-verify="required" placeholder="请输入资讯名称" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
...
<!--                 </div> -->
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="checkbox" name="is_display" lay-skin="switch" lay-text="是|否">
                    </div>
                </div>
                ...
                <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="keywords" required value="" lay-verify="required" placeholder="请输入关键词" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block">
                       ...
                       @foreach($tags as $v)
                        <li data="{{$v->id}}">x&nbsp;<span>{{$v->tagname}}</span></li>
                        @endforeach
                        </div>
                        </div>
