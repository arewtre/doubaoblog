...
<!--                <a href="{{url('ajaxGetForum/1')}}" ><button type="button" class="layui-btn layui-btn-primary"><i class="fa fa-cloud-download"></i>导出</button></a> -->
    ...
    <script>
        layui.use(['table','form','laydate'], function () {
            ...
            table.render({
                elem: '#LAY_table_user'
                , url: "{{url('admin/forum_card')}}"
		        ,loading :true
                , cols: [[
//                    { fixed: 'left',checkbox:true,width:"4%",},
                    { field: 'art_thumb', title: '缩略图',width:"12%", sort: true,templet:"<div>@{{d.art_thumb}}</div>"}
                    , { field: 'title', title: '帖子标题',width:"36%", sort: true}
                    , { field: 'defectsname', title: '分类',width:"10%", sort: true}
                    , { field: 'views', title: '点击数',width:"10%", sort: true}
                    , { field: 'created_at', title: '发布时间',width:"12%",sort: true}
            ...
            table.on('tool(useruv)', function (obj) {
                ...
                if (obj.event === 'detail') {
                    ...
                    layer.open({
                        ...
                        area: ['80%', '80%'],
                        maxmin: true,
                        content: "/admin/forum_edit?id="+ data.forum_id,
                    });
                }
            });
