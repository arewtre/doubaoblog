...
<div class="layui-fluid" id="LAY-app-message">
    <div class="layui-card">
          <div class="layui-card-header">添加博客</div>
            <form class="layui-form layui-form-pane" id="formid" action="">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="art_title" required value="" lay-verify="required" placeholder="请输入技术博客文章名称" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label"><span style="color:red">*</span>技术类别</label>
                    <div class="layui-input-block">
                        <select name="cate_id" lay-verify="required">
                            <option value="">请选择技术博客文章分类</option>
                    ...
                    <div class="layui-input-block">
                         <div class="layui-inline">
                    		<div class="layui-input-inline" style="width:400px;">
								<input type="text" readonly="readonly" value="" name="art_thumb" id="upload-image-url" class="layui-input" style="width:400px" autocomplete="off">
								<input type="hidden" class="layui-input" value="" name="art_thumb" id="upload-image-url">
							</div>
						</div>
						<div class="layui-inline">
...
<!--                 </div> -->
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="checkbox" name="art_istop" lay-skin="switch" lay-text="是|否">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">是否显示</label>
                    <div class="layui-input-block">
                        <input type="checkbox" name="is_display" lay-skin="switch" checked lay-text="是|否">
                    </div>
                </div>
                <div class="layui-form-item layui-form-text">
                    <label class="layui-form-label">博客描述</label>
                    <div class="layui-input-block">
                        <textarea name="art_description" style="height:100px;"class="layui-input"></textarea>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text">
                ...
                <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block">
                       <textarea style="height:500px;width:100%;" id="editor_id" class="span7 richtext-clone layui-input" name="art_content" cols="70"></textarea>
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-input-block">
