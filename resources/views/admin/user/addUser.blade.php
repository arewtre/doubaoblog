...
<!--              <div class="layui-form-item">
            ...
            @if(!empty($info))
              <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                  <input type="hidden" name="user_id" value="{{$info->user_id}}" class="layui-input">
                  <input type="text" name="user_name" value="{{$info->user_name}}" class="layui-input">
                </div>
            ...
            <div class="layui-form-item">
                <label class="layui-form-label">用户名</label>
                <div class="layui-input-inline">
                  <input type="text" name="user_name" value="" class="layui-input">
                </div>
                <div class="layui-form-mid layui-word-aux">不可修改。一般用于后台登入名</div>
              </div>
              <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                  <input type="text" name="user_pass" value="" class="layui-input">
                </div>
              </div>
              <div class="layui-form-item">
                <label class="layui-form-label">性别</label>
              ...
              <div class="layui-form-item">
                <label class="layui-form-label">头像</label>
                <div class="layui-input-inline">
                  <input name="avatar" lay-verify="required" disabled id="LAY_avatarSrc" placeholder="图片地址" value="" class="layui-input">
                </div>
                <div class="layui-input-inline layui-btn-container" style="width: auto;">
                  <button type="button" class="layui-btn layui-btn-primary" id="LAY_avatarUpload">
                    <i class="layui-icon">&#xe67c;</i>上传图片
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <div id="upload-image-preview" style="margin-top:0px;">
                        <img id="demo1" src="{{asset('resources/admin/images/nopic.jpeg')}}" style="width:112px;height:80px">
                    </div> 
                </div>
            </div>
              <div class="layui-form-item">
                <label class="layui-form-label">手机</label>
                <div class="layui-input-inline">
                  <input type="text" name="tel" value="" lay-verify="phone" class="layui-input">
                </div>
              </div>
              <div class="layui-form-item">
                <label class="layui-form-label">邮箱</label>
		      ...
		      layer.msg('上传成功');
		       layer.closeAll('loading');
                ...
                form.on('submit(setmyinfo)', function(data) {
                    ...
                    $.post("{{url('admin/user_add')}}", data.field, function(res) {
                         if (res.code!=1) {
                             layer.msg(res.msg, {
                                 icon: 2
                             });
