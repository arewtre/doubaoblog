            ...
            <form class="layui-form layui-form-pane" id="formid" action="">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="xc_name" required value="" lay-verify="required" placeholder="请输入相册名称" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select name="pid" lay-verify="required">
                            ...
                            @foreach($CategoryList as $vo)
                                <option value="{{$vo['id']}}" {{$vo['pid'] == 0?'disabled':''}}>{{$vo['showName']}}</option>
                           @endforeach
                        </select>
                    </div>
                </div>
                    ...
                    <div class="layui-input-block">
                         <div class="layui-inline">
                    		<div class="layui-input-inline" style="width:400px;">
								<input type="text" readonly="readonly" value="" name="fengm" id="upload-image-url" class="layui-input fengm" style="width:400px" autocomplete="off">
...
<!--                 </div>                -->
                ...
                <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block">
                        <textarea name="xc_desc" style="height:100px;"class="layui-input"></textarea>
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-input-block">
