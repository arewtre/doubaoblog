            ...
            <form class="layui-form layui-form-pane" id="formid" action="">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="title" required value="{{$detail->title}}" lay-verify="required" placeholder="请输入广告名称" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label"><span style="color:red">*</span>有效周期</label>
                    <div class="layui-inline">
                        <input type="text" id="timestart" name="start_time" required value="{{$detail->start_time}}" lay-verify="required" placeholder="请输入开始时间" class="layui-input">
                    </div>
                     <div class="layui-inline">
                        -
                    </div>
                     <div class="layui-inline">
                        <input type="text" id="timeend" name="end_time" required value="{{$detail->end_time}}" lay-verify="required" placeholder="请输入结束时间" class="layui-input">
                    </div>
                </div>
                 <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                         <div class="layui-inline">
                    		<div class="layui-input-inline" style="width:400px;">
								<input type="text" readonly="readonly" value="{{$detail->pic_url}}" name="pic_url" id="upload-image-url" class="layui-input" style="width:400px" autocomplete="off">
								<input type="hidden" class="layui-input" value="{{$detail->pic_url}}" name="pic_url" id="upload-image-url">
							</div>
						</div>
						<div class="layui-inline">
						...
						<div id="upload-image-preview" style="margin-top:10px;">
	                    		<img src="{{$detail->pic_url}}" style="width:112px;height:80px">
                		</div>     
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select name="url_type" lay-verify="required">
                            <option value="1" @if(isset($detail->url_type) && $detail->url_type==1) selected @endif>URL地址</option>
                            <option value="2" @if(isset($detail->url_type) && $detail->url_type==2) selected @endif>文章ID</option>
                            <option value="3" @if(isset($detail->url_type) && $detail->url_type==3) selected @endif>相册ID</option>
                        </select>
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="url" required value="{{$detail->url}}" lay-verify="required" placeholder="请输入广告链接地址" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select name="ad_slots" lay-verify="required">
                            @foreach($as_slots as $v) 
            	        	  <option value="{{$v->id}}" {{$v->id == $detail->ad_slots?'selected':''}}>{{$v->ad_name}}</option>
            	        	@endforeach 
                        </select>
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="checkbox" name="status" {{($detail->status == 1?'checked':'')}} lay-skin="switch" lay-text="是|否">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">广告说明</label>
                    <div class="layui-input-block">
                        <textarea name="explanation" value="{{$detail->explanation}}" style="height:100px;"class="layui-input"></textarea>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">广告排序</label>
                    <div class="layui-input-block">
                       <input type="text" name="sort" required value="{{$detail->sort}}" lay-verify="required" placeholder="请输入广告链接地址" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-input-block">
