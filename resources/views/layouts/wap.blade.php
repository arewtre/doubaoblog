...
<head>
    ...
    <script src="{{asset('resources/wap/js/clipboard.min.js')}}"></script>
    ...
    <!--jquery.mmenu -->
    <link rel="stylesheet" href="{{asset('resources/wap/touch/images/style.css?ver=1.1')}}" type="text/css" /> 
    <link rel="stylesheet" href="{{asset('resources/wap/touch/images/media50px.css?ver=1.3')}}" type="text/css">
