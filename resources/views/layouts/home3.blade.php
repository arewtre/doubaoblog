...
<head>
    ...
    <meta name="keywords" content="{{$forum->title}}_{{Site::get('webname')}}" /> 
    <meta name="description" content="{{$forum->title}}_{{Site::get('webname')}} " /> 
    ...
    <script type="text/javascript">
        var allowbbcode = allowimgcode = parsetype = 0;
		     var allowhtml = forumallowhtml = allowsmilies = 0;
        var STYLEID = '2', STATICURL = '/resources/wap/static/', IMGDIR = '/resources/wap/static/image/common', VERHASH = 'pCV', charset = 'utf8', discuz_uid = '1', cookiepre = 'OZJL_2132_', cookiedomain = '', cookiepath = '/', showusercard = '1', attackevasive = '0', disallowfloat = 'newthread', creditnotice = '1|威望|,2|金钱|,3|贡献|', defaultstyle = '', REPORTURL = '', SITEURL = 'http://linxinran.cn/', JSPATH = '/resources/home/js/';</script>
   ...
   <div class="wp cl"> 
    <div class="cl"> 
     ...
     <div id="frt"> 
      ...
      <p class="xs0 mtm">Powered by <a href="{{Site::get('webaddress')}}" target="_blank">九月一十八!</a> <em>X1.0</em> <span>{{Site::get('copyright')}}</span></p> 
     </div>
    </div> 
    <div class="xr_ft"> 
