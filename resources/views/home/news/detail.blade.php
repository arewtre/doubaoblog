...
<link rel="stylesheet" type="text/css" href="{{asset('resources/home/css/style_2_portal_view.css')}}" /> 
  ...
  <style id="diy_style" type="text/css">#frameB5kNqK {  border:0px none !important;}#portal_block_59 {  border:0px none !important;}#frameP74r1Q {  border:0px none !important;}#portal_block_60 {  border:0px none !important;}</style> 
  <div class="wp"> 
   <!--[diy=diy1]-->
     ...
     <div class="d" style="padding:0 20px"> 
       ...
       <tbody>
        <tr>
         <td id="article_content">
             <!--<p><a href="" target="_blank"><img src="{{$detail->art_thumb}}" /></a></p>-->
         {!! nl2br($detail->art_content) !!}
         </td>
        </tr>
       </tbody>
      </table> 
      ...
      <div id="click_div">
       <table cellpadding="0" cellspacing="0" class="atd"> 
        <tbody>
         <tr>
          <td><a href="javascript:;" id="click_aid_9_5" onclick="addbt(this);"data-href="{{url('biaotai/'.$detail->art_id.'/1/1')}}"> 
            <div class="atdc"> 
             <div class="ac2" style="height:{{$bt[0]*2+1}}px;"> 
              <em>{{$bt[0]}}</em> 
             </div> 
            </div> <img src="{{asset('resources/home/images/xianhua.gif')}}" alt="" /><br />鲜花</a> </td> 
          <td> <a href="javascript:;" id="click_aid_9_5" onclick="addbt(this);"data-href="{{url('biaotai/'.$detail->art_id.'/2/1')}}"> 
            <div class="atdc"> 
             <div class="ac1" style="height:{{$bt[1]*2+1}}px;"> 
              <em>{{$bt[1]}}</em> 
             </div> 
            </div> <img src="{{asset('resources/home/images/woshou.gif')}}" alt="" /><br />握手</a> </td> 
          <td> <a href="javascript:;" id="click_aid_9_5" onclick="addbt(this);"data-href="{{url('biaotai/'.$detail->art_id.'/3/1')}}"> 
            <div class="atdc"> 
             <div class="ac3" style="height:{{$bt[2]*2+1}}px;"> 
              <em>{{$bt[2]}}</em> 
             </div> 
            </div> <img src="{{asset('resources/home/images/leiren.gif')}}" alt="" /><br />雷人</a> </td> 
          <td> <a href="javascript:;" id="click_aid_9_5" onclick="addbt(this);"data-href="{{url('biaotai/'.$detail->art_id.'/4/1')}}"> 
            <div class="atdc"> 
             <div class="ac4" style="height:{{$bt[3]*2+1}}px;"> 
              <em>{{$bt[3]}}</em> 
             </div> 
            </div> <img src="{{asset('resources/home/images/luguo.gif')}}" alt="" /><br />路过</a> </td> 
          <td> <a href="javascript:;" id="click_aid_9_5" onclick="addbt(this);"data-href="{{url('biaotai/'.$detail->art_id.'/5/1')}}"> 
            <div class="atdc"> 
...
<!--     <div class="o cl ptm pbm"> 
     ...
     <div class="pren pbw ptw cl"> 
      @if($pre)
         <em>上一篇：<a href="{{url('news_'.$pre->art_id.'.html')}}">{{$pre->art_title}}</a></em>
      @endif
      @if($next)
         <em>下一篇：<a href="{{url('news_'.$next->art_id.'.html')}}">{{$next->art_title}}</a></em>
      @endif
     </div> 
    </div> 
     ...
     <div class="hotPost"> 
      <div class="block" style="margin:0;"> 
       <div class="module cl xl xl1"> 
        <ul id="raid_div">
         @foreach($xg as $v)
            <li><a href="{{url('news_'.$v->art_id.'.html')}}">{{$v->art_title}}</a></li>
         @endforeach
        </ul> 
       </div> 
      </div> 
    ...
    <div class="pComment">
     <div id="comment" class="bm"> 
      ...
      <div id="comment_ul" class="bm_c">      
       ...
       <form id="cform" name="cform" action="{{url('addrep/'.$detail->art_id.'/1')}}" method="post" autocomplete="off">
           {{csrf_field()}} 
        <div class="tedt"> 
         <div class="area"> 
    ...
    <div class="bp colu"> 
     ...
     <div class="dxb_bc" style="padding-bottom:20px;"> 
      <ul class="module cl xl xl2 cl">
       @foreach($ncate as $v)
          <li> <a href="{{url('news?cid='.$v->id)}}">{{$v->defectsname}}</a></li> 
       @endforeach
      </ul> 
     </div> 
    </div> 
