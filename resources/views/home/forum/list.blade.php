      ...
      <div class="bp"> 
       <div class="listTit cl"> 
        ...
        <div class="xr_tit_r z"> 
         <div class="xr_stat y"> 
          <ul class="cl"> 
           <li>今日<span>{{getForum($mod['id'],1)}}</span> </li> 
           <li>主题<span>{{getForum($mod['id'],2)}}</span></li> 
           <!--<li>排名<span title="上次排名:7">12</span></li>--> 
           <li class="last">关注<span id="number_favorite_num">{{$mod->views}}</span></li> 
          </ul> 
         </div> 
        </div> 
       </div> 
           ...
           <tr> 
            ...
            <th class="common"> 
             <div class="tl_tit cl"> 
              ...
              <h3> 
                  <a href="{{url('forum_list_detail/'.$v->forum_id.'?pid='.$v->pid)}}" onclick="atarget(this)" class="xst" style="max-width:400px">【讨论】{{$v->title}}</a> 
...
<!--                    <li>
                        <span>-->
                            <!--<img id="_aimg_611" aid="611" onclick="zoom(this, this.getAttribute('zoomfile'), 0, 0, '')" zoomfile="{{$v->video}}?vframe/jpg/offset/2/w/160" src="{{$v->video}}?vframe/jpg/offset/2/w/160" alt="" title="" w="850" />-->
                        {!! nl2br($v->video) !!}
<!--                        </span>
                    </li>-->
                </div>
