...
//!supporttouch && (window.location.href = 'wap/forum');
	...
	open : function(pop, type, url) {
		...
		if(typeof pop == 'string') {
			...
			if(type == 'alert') {
				...
				pop = '<div class="tip"><dt>'+ pop +'</dt><dd><a href="'+ url +'"><input class="redirect button2" type="button" value="确定"></a><a href="javascript:;" onclick="popup.close();">取消</a></dd></div>'
			}
		...
		if(POPMENU[pop.attr('id')]) {
			...
			pop.parent().append('<div class="dialogbox" id="'+ pop.attr('id') +'_popmenu" style="border:0px solid #D7D7D7; height:'+ pop.height() +'px;width:'+ pop.width() +'px;">'+ pop.html() +'</div>');
		}
